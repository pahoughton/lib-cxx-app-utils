...
//	inline
//  	Log( ostream &		outStream = cout,
//  	     const char *	outLevel = LogLevel::Error,
//  	     bool		stampLevel = true,
//  	     bool		stampTime = true,
//	     bool		stampLoc = true );
...
//	inline
//	Log &
//	operator () ( LogLevel::Level current )
...
//	inline
//	void
//	open( const char *  fileName, ios::open_mode mode = ios::app )
...
//	inline
//	void
//	setFileName( const char * fileName, ios::open_mode mode = ios::app )
